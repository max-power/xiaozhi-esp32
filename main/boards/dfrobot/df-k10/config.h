...
/* SD card (SPI2) — SCK=GPIO44, MOSI=GPIO42, MISO=GPIO41, CS=GPIO40. */
#define SD_SPI_SCK_PIN   GPIO_NUM_44
#define SD_SPI_MOSI_PIN  GPIO_NUM_42
#define SD_SPI_MISO_PIN  GPIO_NUM_41
#define SD_SPI_CS_PIN    GPIO_NUM_40
